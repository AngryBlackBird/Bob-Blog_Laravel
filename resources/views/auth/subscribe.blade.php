        ...
        <form action="" method="post">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    <label for="name" class="block pb-3 font-body font-medium text-primary dark:text-white">
                        Nom
                    </label>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    <label for="password_confirmation" class="block pb-3 font-body font-medium text-primary dark:text-white">
